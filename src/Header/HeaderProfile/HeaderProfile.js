...
function HeaderProfile() {
    ...
    return (
        <div className="HeaderProfile" onClick={(e) => {
            if (!isShown) {
                e.stopPropagation();
                setIsShown(true);
            }
            ...
            <HeaderProfileMenu isShown={isShown} setIsShown={setIsShown}>
                <li><Link to="/"><span>Feed</span></Link></li>
                <li><Link to={"/profile/" + user.username}><span>Profile</span></Link></li>
                <li><Link to="/search"><span>Search</span></Link></li>
                <li><Link to="/post/create"><span>Create Post</span></Link></li>
